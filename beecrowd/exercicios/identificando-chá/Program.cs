...
class URI {
    ...
    static void Main(string[] args) { 
        ...
        Console.WriteLine("Digite a resposta(Deve ser um inteiro >=1 ou <= 4");
        t = int.Parse(Console.ReadLine());
                
        for(int i = 0; i < 4; i++ ){
        Console.WriteLine($"Resposta dos participante {i + 1}:");
        ...
        Console.WriteLine($"Número de concorrentes que obtiveram a resposta correta: {qnt}");
    }
